...
public class Hyunsolapi {
    ...
    public static ItemStack getItemStack(Material itemType, int amount, String itemName, @Nullable ArrayList<String> itemLore, @Nullable int itemDamage) {
        ...
        if(itemDamage != 0) ((Damageable) meta).damage(itemDamage);
    ...
    public void save(HashMap map, String fileName) {
        File f = new File(Script.main.getDataFolder()+"/"+fileName+".hyun");
    ...
    public void load(HashMap map, String fileName) {
        ...
        File f = new File(Script.main.getDataFolder()+"/"+fileName);

        try {
            FileReader r = new FileReader(Script.main.getDataFolder()+"/"+fileName+".hyun");
